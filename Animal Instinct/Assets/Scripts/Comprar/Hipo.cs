...
public class Hipo : MonoBehaviour {
    ...
    void Start()
    {
        unlocked = PlayerPrefs.GetInt("unlockedHipo") == 1;
        locked = PlayerPrefs.GetInt("lockedHipo") == 0;
    ...
    public void Buy()
    {
        ...
        unlocked = true;
        PlayerPrefs.SetInt(("unlockedHipo"), 1);
        PlayerPrefs.SetInt(("lockedHipo"), 1);
        PlayerPrefs.Save();
