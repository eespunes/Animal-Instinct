...
public class Gos3 : MonoBehaviour {
    ...
    void Start()
    {
        unlocked = PlayerPrefs.GetInt("unlockedGo3") == 1;
        locked = PlayerPrefs.GetInt("lockedGo3") == 0;
    ...
    public void Buy()
    {
        ...
        unlocked = true;
        PlayerPrefs.SetInt(("unlockedGo3"), 1);
        PlayerPrefs.SetInt(("lockedGo3"), 1);
        PlayerPrefs.Save();
