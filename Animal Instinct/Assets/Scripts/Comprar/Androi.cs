...
public class Androi : MonoBehaviour {
    private bool unlocked;
    private bool locked;
    private int puntuacioarest = 10000;
    ...
    void Start()
    {
        unlocked = PlayerPrefs.GetInt("unlockedAnd") == 1;
        locked = PlayerPrefs.GetInt("lockedAnd") == 0;
    ...
    public void Buy()
    {
        ...
        unlocked = true;
        PlayerPrefs.SetInt(("unlockedAnd"), 1);
        PlayerPrefs.SetInt(("lockedAnd"), 1);
        PlayerPrefs.Save();
