...
public class Gat3 : MonoBehaviour {
    ...
    void Start()
    {
        unlocked = PlayerPrefs.GetInt("unlockedGa3") == 1;
        locked = PlayerPrefs.GetInt("lockedGa3") == 0;
    ...
    public void Buy()
    {
        ...
        unlocked = true;
        PlayerPrefs.SetInt(("unlockedGa3"), 1);
        PlayerPrefs.SetInt(("lockedGa3"), 1);
        PlayerPrefs.Save();
