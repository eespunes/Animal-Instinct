...
public class Gat2 : MonoBehaviour {
    ...
    void Start()
    {
        unlocked = PlayerPrefs.GetInt("unlockedGa2") == 1;
        locked = PlayerPrefs.GetInt("lockedGa2") == 0;
    ...
    public void Buy()
    {
        ...
        unlocked = true;
        PlayerPrefs.SetInt(("unlockedGa2"), 1);
        PlayerPrefs.SetInt(("lockedGa2"), 1);
        PlayerPrefs.Save();
