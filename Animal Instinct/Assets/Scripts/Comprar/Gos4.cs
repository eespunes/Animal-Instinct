...
public class Gos4 : MonoBehaviour {
    ...
    void Start()
    {
        unlocked = PlayerPrefs.GetInt("unlockedGo4") == 1;
        locked = PlayerPrefs.GetInt("lockedGo4") == 0;
    ...
    public void Buy()
    {
        ...
        unlocked = true;
        PlayerPrefs.SetInt(("unlockedGo4"), 1);
        PlayerPrefs.SetInt(("lockedGo4"), 1);
        PlayerPrefs.Save();
